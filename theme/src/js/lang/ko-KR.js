const lang = {
    ...
    'ERRDLG_UNSUPPORTED_INFO_STABLE': '이 버전의 Spotify는 이 버전의 WMPotify에서 지원되지 않습니다. 가능한 해결책:<br>- Spotify를 지원되는 버전으로 다운그레이드하거나 업데이트하십시오. 지원되는 버전: %s<br>- Spicetify Marketplace에서 WMPotify의 사전 릴리스 버전을 사용해 보십시오.',
    'ERRDLG_UNSUPPORTED_INFO_PREREL': '이 버전의 Spotify는 아직 WMPotify에서 지원되지 않습니다. 가능한 해결책:<br>- Spotify를 지원되는 버전으로 다운그레이드하거나 업데이트하십시오. 지원되는 버전: %s<br>- WMPotify GitHub 이슈 페이지에 이 문제를 보고하고 수정될 때까지 기다리십시오.',
